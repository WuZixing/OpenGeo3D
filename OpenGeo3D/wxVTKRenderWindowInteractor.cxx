...
void wxVTKRenderWindowInteractor::SetupRenderWindow(vtkRenderer* renderer) {
    vtkInteractorStyleSwitch* styleSwitch = vtkInteractorStyleSwitch::SafeDownCast(GetInteractorStyle());
    if (styleSwitch) {
...
/*
vtkRenderer* wxVTKRenderWindowInteractor::GetDefaultRenderer() const {
    return renderer_;
}
*/